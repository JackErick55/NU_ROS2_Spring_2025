...
class Waypoints_Event(metaclass=Metaclass_Waypoints_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<turtle_interfaces/Waypoints_Request, 1>',
        'response': 'sequence<turtle_interfaces/Waypoints_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['turtle_interfaces', 'srv'], 'Waypoints_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['turtle_interfaces', 'srv'], 'Waypoints_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from turtle_interfaces.srv import Waypoints_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from turtle_interfaces.srv import Waypoints_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_Waypoints(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from turtle_interfaces.srv import _waypoints
...
class Waypoints(metaclass=Metaclass_Waypoints):
    from turtle_interfaces.srv._waypoints import Waypoints_Request as Request
    from turtle_interfaces.srv._waypoints import Waypoints_Response as Response
    from turtle_interfaces.srv._waypoints import Waypoints_Event as Event
